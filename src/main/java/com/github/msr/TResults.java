...
public class TResults implements org.apache.thrift.TBase<TResults, TResults._Fields>, java.io.Serializable, Cloneable, Comparable<TResults> {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<String>> results; // required
    public @org.apache.thrift.annotation.Nullable java.util.List<String> schema; // optional
    ...
    public TResults(TResults other) {
        if (other.isSetResults()) {
            java.util.List<java.util.List<String>> __this__results = new java.util.ArrayList<java.util.List<String>>(other.results.size());
            for (java.util.List<String> other_element : other.results) {
                java.util.List<String> __this__results_copy = new java.util.ArrayList<String>(other_element);
                __this__results.add(__this__results_copy);
            }
            this.results = __this__results;
        }
        if (other.isSetSchema()) {
            java.util.List<String> __this__schema = new java.util.ArrayList<String>(other.schema);
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<java.util.List<String>> getResultsIterator() {
        return (this.results == null) ? null : this.results.iterator();
    }

    public void addToResults(java.util.List<String> elem) {
        if (this.results == null) {
            this.results = new java.util.ArrayList<java.util.List<String>>();
        }
        this.results.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<java.util.List<String>> getResults() {
        return this.results;
    }

    public TResults setResults(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<String>> results) {
        this.results = results;
        return this;
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<String> getSchemaIterator() {
        return (this.schema == null) ? null : this.schema.iterator();
    }

    public void addToSchema(String elem) {
        if (this.schema == null) {
            this.schema = new java.util.ArrayList<String>();
        }
        this.schema.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<String> getSchema() {
        return this.schema;
    }

    public TResults setSchema(@org.apache.thrift.annotation.Nullable java.util.List<String> schema) {
        this.schema = schema;
        return this;
    }
        ...
        switch (field) {
            case RESULTS:
                if (value == null) {
                    ...
                    setResults((java.util.List<java.util.List<String>>)value);
                }
                break;
            ...
            case SCHEMA:
                if (value == null) {
                    ...
                    setSchema((java.util.List<String>)value);
                }
                break;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TResults(");
        boolean first = true;
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.results = new java.util.ArrayList<java.util.List<String>>(_list0.size);
                                @org.apache.thrift.annotation.Nullable java.util.List<String> _elem1;
                                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                                {
                                    {
                                        org.apache.thrift.protocol.TList _list3 = iprot.readListBegin();
                                        _elem1 = new java.util.ArrayList<String>(_list3.size);
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.schema = new java.util.ArrayList<String>(_list6.size);
            ...
            if (struct.schema != null) {
                if (struct.isSetSchema()) {
                    oprot.writeFieldBegin(SCHEMA_FIELD_DESC);
                    {
                        ...
                        for (String _iter11 : struct.schema)
                        {
            ...
            if (struct.isSetResults()) {
                {
                    ...
                    for (java.util.List<String> _iter12 : struct.results)
                    {
                        {
            ...
            if (struct.isSetSchema()) {
                {
                    ...
                    for (String _iter14 : struct.schema)
                    {
            ...
            if (incoming.get(0)) {
                {
                    ...
                    struct.results = new java.util.ArrayList<java.util.List<String>>(_list15.size);
                    @org.apache.thrift.annotation.Nullable java.util.List<String> _elem16;
                    for (int _i17 = 0; _i17 < _list15.size; ++_i17)
                    {
                        {
                            org.apache.thrift.protocol.TList _list18 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
                            _elem16 = new java.util.ArrayList<String>(_list18.size);
            ...
            if (incoming.get(1)) {
                {
                    ...
                    struct.schema = new java.util.ArrayList<String>(_list21.size);
